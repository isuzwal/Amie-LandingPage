  ...
  return (
    <div className="w-full  py-6 mt-20  px-2 ">
      ...
      <div className=" w-full flex flex-col gap-3">
        ...
        <div className="p-3">
          {/* <div className="w-full text-center rounded-md overflow-hidden bg-blue-400/60 ">
            Video Section Here
          </div> */}
          <div className="w-full  px-5 py-2 mt-4  relative">
            ...
            <p className="text-neutral-800 font-sans font-medium text-start text-[16px]">
              ...
              tsaks inone click is killer feature.
            </p>
            <span className="text-neutral-400 font-sans text-[14px] ">
              Gabriel Saillard. Software Enginner
            </span>
          </div>
        </div>
        <div>
          <div className="p-2">
            ...
            <div className="flex flex-col gap-6 justify-start  mt-6 ">
              ...
              <p className="text-neutral-600 font-sans  text-start">
                {' '}
                If you want Amie to work fully in the background, you can enable
                fully-automatic recordings. This will record every call without
            ...
            <div className="flex flex-col  justify-start  mt-6 ">
              ...
              <div className="flex flex-col gap-6 mt-4">
                <p className="text-neutral-600 font-sans  text-start">
                  ...
                  summary. You can define the headings we should use. List out
                  key numbers as emphasis. Or use it to prepare the agenda.
                </p>
                <p className="text-neutral-600 font-sans text-start">
